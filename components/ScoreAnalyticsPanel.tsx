...
const styles = StyleSheet.create({
  wrap: { gap: 14 },
  intro: { fontSize: 14, color: MUTED, marginBottom: 6, lineHeight: 21 },
  ...
  muted: { fontSize: 14, color: MUTED2, marginBottom: 10, lineHeight: 21 },
  statRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10 },
  statLabel: { fontSize: 15, color: 'rgba(255,255,255,0.55)', flex: 1, paddingRight: 8 },
  statValue: { fontSize: 15, fontWeight: '700', color: WHITE, textAlign: 'right', maxWidth: '56%' },
