...
const styles = StyleSheet.create({
  ...
  chipOn: { borderColor: GOLF.accent, backgroundColor: 'rgba(181,255,58,0.15)' },
  ...
  betCardOn: { borderColor: GOLF.accent, backgroundColor: 'rgba(181,255,58,0.12)' },
  ...
  toggleOn: { backgroundColor: 'rgba(181,255,58,0.20)', borderColor: 'rgba(181,255,58,0.45)' },
  toggleKnob: {
    width: 20,
    height: 20,
    borderRadius: 999,
