...
const entryIconSource = require('../../assets/images/golf-check-icon.png');
...
const s = StyleSheet.create({
  ...
  entryIconWrap: { width: 36, alignItems: 'center', justifyContent: 'center' },
  entryIcon: { width: 26, height: 26 },
